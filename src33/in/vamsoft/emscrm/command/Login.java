...
public class Login implements Command{
	...
	public String execute(HttpServletRequest request,
		...
		session.setAttribute(
				CommandUtil.SEMP_ID, empId);
		context.setAttribute(
				CommandUtil.SEMP_ID, empId);
		System.out.println("Session EmpId"+session.getAttribute(CommandUtil.SEMP_ID));
		String empName = emp.getEmpName();
		session.setAttribute(
				CommandUtil.SEMP_NAME, empName);
		context.setAttribute(
				CommandUtil.SEMP_NAME, empName);
		System.out.println("Session EmpName"+session.getAttribute(CommandUtil.SEMP_NAME));
		Date date=new Date();
		...
		{	
			if(emp.getRole().equals(CommandUtil.RADMIN)){
				...
				if(isLoggedInUser==false){
					...
					context.setAttribute(CommandUtil.SEMP, emp);
			...
			}else
			{
				...
				if(isLoggedInUser==false){
					...
					session.setAttribute(CommandUtil.SEMP, emp);
					System.out.println("sessiom  "+session.getAttribute(CommandUtil.SEMP));
					context.setAttribute(CommandUtil.SEMP, emp);
					...
					context.setAttribute(
							CommandUtil.SEMP_ID, emp.getEmpId());
					context.setAttribute(
							CommandUtil.SEMAIL_ID, emp.getEmailId());
					session.setAttribute(
