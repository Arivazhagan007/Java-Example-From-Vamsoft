...
public class Employeenewticket implements Command{
	...
	public String execute(HttpServletRequest request,
		...
		Employee employee=(Employee) session.getAttribute(CommandUtil.SEMP);
		...
		int rows=newTicket(empId,eventName,eventDate,eventTime,location,noOfTicket,category,price,tolalPrice,request);
	...
	private int newTicket(int empId, String eventName, String eventDate,
		...
		try {
			statement=connection.prepareStatement(SQLHolder.INSERTEMPTICKETQUERY);
